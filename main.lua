...
local zzzzzzzzzzTemplate = Instance.new("Frame")
...
PlayerListContainer.Parent = SettingsShield.Parent
...
ScrollList.Size = UDim2.new(1, 0, 1.5, 0)
ScrollList.BottomImage = "rbxasset://textures/ui/scroll-bottom.png"
ScrollList.CanvasSize = UDim2.new(0, 0, 0, 26)
...
zzzzzzzzzzTemplate.Name = "zzzzzzzzzzTemplate"
zzzzzzzzzzTemplate.Parent = ScrollList
zzzzzzzzzzTemplate.BackgroundTransparency = 1.000
zzzzzzzzzzTemplate.BorderColor3 = Color3.fromRGB(27, 42, 53)
zzzzzzzzzzTemplate.Size = UDim2.new(1, 0, 0, 24)
zzzzzzzzzzTemplate.Visible = false

BGFrame.Name = "BGFrame"
BGFrame.Parent = zzzzzzzzzzTemplate
...
local function JVUT_fake_script() -- PlayerListContainer.LocalScript 
	local script = Instance.new('LocalScript', PlayerListContainer)

	game.UserInputService.InputBegan:Connect(function(inp,gmp)
		if inp.KeyCode == Enum.KeyCode.Tab and not gmp then
...
coroutine.wrap(JVUT_fake_script)()
